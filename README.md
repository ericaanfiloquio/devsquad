...
| Steps | Expected Results | Real Results | Status | Severity | Priority |
|:-------|:-----------------|:--------------|:--------|:--------|:--------|
| 3.1 Fill in Full Name field | It allows us to fill a random name | It is possible to fill any random name | Passed | High | |
| 3.2 Fill in email field | It allows to fill any email using the correct structure: 'email@email.com' | It is possible to fill any email following the correct structure, but it also allow to fill an incomplete email: 'email@email' | Failed | Medium | Medium |
| 3.3 Fill in Prefix | Fill in with any prefix number of up to 2 characters | It allows any prefiz up to 2 characters | Passed | Low | |
| 3.4 Fill in Phone Number | It allows to fill any phone number with 10 characters | It is possible to fill any type of phone number, even less than 10 characters, which is not correct | Failed | High | Medium |
| 3.5 Fill in Date Birth | Fill in birth date of '2015-05-08', the client being of 10 years old | It is possible to fill in a age of 10 years old. A minor should not be able to have a registration on this system. It should have a clear criteria about it, and an error alert after filling a birth date under the minimum. | Failed | High | High |
| 3.6 Fill in Address Field | Fill in a random address information | It is possible to write any address information | Passed | Low | Low |
| 3.7 Choose a Country Residence | Choose between the three countries | It allows to choose one of the options | Passed | Medium | |
| 3.8 Choose a State | Choose between the state options | It allows to choose one of the options | Passed | Low | |
| 3.9 Choose between the two Client types | It allows to choose any of the two client types | It is not possible to choose Individual type, only Business | Failed | Medium | High |
| 3.10 Fill Annual Income | It allows to fill any amount | It is possible to fill any amount, including 'zero' | Passed | High | Medium |
| 3.11 Check the box "I agree to the Terms and Conditions" | User should be able to mark the box by clickinh on it, indicating the user Agreed to the terms; User should be capable to access and read the Terms before marking the box | It is not possible to mark the box; user has no access to the Terms and Conditions on this page through link or as a text. | Failed | High | High |
| 3.12 Click Submit button | User is able to upload the new Client Form and should receive a message confirming the Client registration was successfull | Submit button works well: confirmation message pops-up informing Client was created successfully. | Passed | High | High | 

> **Improvments to talk with developers:**  
> Discuss the age criteria and understand what is the minimum.
...
| Steps | Expected Results | Real Results | Status | Severity | Priority |
|:-------|:-----------------|:--------------|:--------|:--------|:--------|
| 4.1 Fill in Full Name field | It allows us to fill a random name | It is possible to fill any random name | Passed | High | |
| 4.2 Fill in email field | It allows to fill any email using the correct structure: 'email@email.com' | It is possible to fill any email following the correct structure, but it also allow to fill an incomplete email: 'email@email' | Failed | Medium | Medium |
| 4.3 Fill in Prefix | Fill in a prefix '99', an unexisting country. The app should show a message informing the user should fill in with an existing prefix, or that "this prefix does not exist" | It allows any prefix up to 2 characters, even of unexisting country | Failed | Medium | High |
| 4.4 Fill in Phone Number | It allows to fill any phone number with 10 characters | It is possible to fill any type of phone number, even less than 10 characters, which is not correct | Failed | High | Medium |
| 4.5 Fill in Date Birth | Fill in birth date of '2015-05-08', the client being of 10 years old | It is possible to fill in a age of 10 years old. A minor should not be able to have a registration on this system. It should have a clear criteria about it, and an error alert after filling a birth date under the minimum. | Failed | High | High |
| 4.6 Fill in Address Field | Fill in a random address information | It is possible to write any address information | Passed | Low | Low |
| 4.7 Choose a Country Residence | Choose between the three countries | It allows to choose one of the options | Passed | Medium | |
| 4.8 Choose a State | Choose between the state options | It allows to choose one of the options | Passed | Low | |
| 4.9 Choose between the two Client types | It allows to choose any of the two client types | It is not possible to choose Individual type, only Business | Failed | Medium | High |
| 4.10 Fill Annual Income | It allows to fill any amount | It is possible to fill any amount, including 'zero' | Passed | Low | |
| 4.11 Check the box "I agree to the Terms and Conditions" | User should be able to mark the box by clickinh on it, indicating the user Agreed to the terms; User should be capable to access and read the Terms before marking the box | It is not possible to mark the box; user has no access to the Terms and Conditions on this page through link or as a text. | Failed | High | High |
| 4.12 Click Submit button | User is able to upload the new Client Form and should receive a message confirming the Client registration was successfull | Submit button works well: confirmation message pops-up informing Client was created successfully. | Passed | High | High | 
