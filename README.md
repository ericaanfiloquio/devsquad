...
Bellow, you will find the full tests descriptions, 2 positive scenarios and 5 negative:

**Positive**
1 - Trying to Create a New Client by filling correctly the Client Profile Form - you can find the automation here: `cypress/e2e/clientForm.spec.cy.js`
2 - 
3 - 
4 - 
5 - 
...
## 3 - Filling up Client Form - being minor 
`clientForm.spec.cy.js`

Pre-conditions:  (https://qa-training.sbx.devsquad.app/list-clients)
...
## 4 - Filling up Client Form - Prefix of unexisting country

## 5 - Filling up Client Form - Without selecting a State

## 6 - Filling up Client Form - Without an email address

## 7 - Filling up Client Form - With no Income